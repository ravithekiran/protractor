...
describe('TA-003 TypeAhead-Recent Search Suggestions Validation',function(){
    logger.info('*****TA-003 TypeAhead-Recent Search Suggestions Validation*****');
     common.loadHomePage(logger);
    ta_common.recentSearchTypeAhead(logger);
